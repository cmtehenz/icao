...
Flight or ground movement when visibility or ceiling is below normal VMC limits.
...
Fog, heavy rain, or haze reduces visibility below approach or taxi minimums.

## Who Uses It

Pilots report visibility; Tower issues RVR if available; Ground may use follow-me for taxi.
...
LOW VIS — Look for runway, Obtain RVR/ATIS, When lost sight go around, Verify minimums, Inform ATC, Stop taxi if unsure.
