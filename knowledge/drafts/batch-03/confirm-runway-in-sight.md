...
ATC request or pilot report verifying visual acquisition of the landing runway.
...
Vector to final, visual approach clearance, or low visibility when ATC needs visual confirmation.

## Who Uses It

ATC asks; pilot confirms or reports runway not in sight.
...
SIGHT — See runway clearly, If not say negative, Go around when required, Honest report, Transmit confirming.
