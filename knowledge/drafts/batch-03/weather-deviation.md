...
Authorized departure from assigned route or heading to avoid adverse weather.
...
En route when thunderstorms, turbulence, or icing block the cleared route.

## Who Uses It

Pilots request from Center; ATC clears deviation and monitors separation.
...
DEVIATE — Declare need, Expect clearance, Vector as cleared, Inform when clear, Apply back to route, Track again.
...
- [SKYbrary — Weather](https://skybrary.aero/articles/weather)
- [ICAO Doc 4444 — Air Traffic Management](https://www.icao.int/safety/airnavigation/pages/doc4444.aspx)
- [FAA AIM — Weather](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap7_section_1.html)
- [EASA Safety](https://www.easa.europa.eu/en/domains/safety)
