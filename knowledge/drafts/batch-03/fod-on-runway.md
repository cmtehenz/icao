...
Foreign object debris on the runway that may damage aircraft or require go-around.
...
Takeoff roll, landing, or taxi when objects are seen on runway surface.

## Who Uses It

Pilots report to Tower; airport operations remove debris.
...
FOD — Find it, Out loud to Tower, Delay landing until clear.
