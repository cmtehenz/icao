...
Sudden change in wind speed or direction encountered on final approach.
...
Final approach below 1,000 feet AGL when micro-scale wind shifts affect airspeed and glide path.

## Who Uses It

Pilots report to Tower; ATC may issue windshear alerts and ask for pilot reports.
...
SHEAR — Slow/add power, Hold altitude, Explain to ATC, Assess go-around, Report for next aircraft.
