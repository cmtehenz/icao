...
Intense localized downdraft near the ground, often associated with thunderstorms.
...
Approach under convective weather when strong downdraft pushes aircraft below glide path.

## Who Uses It

Pilots declare to Tower; ATC halts departures and arrivals on affected runway.
...
BURST — Build power, Urgent Mayday, Recover altitude, Say position, Turn away from storm.
