...
Unpowered balloon traffic in vicinity of aircraft flight path.
...
Visual approach or VFR segment when balloon drifts into aircraft path.

## Who Uses It

Pilots report to Approach; ATC issues traffic alerts and heading changes.
...
BALLOON — Balloon in sight, Alert ATC, Left/right turn as cleared, Look out, Out of conflict, Notify clear.
...
- [FAA AIM — Weather & Balloon Operations](https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap7_section_1.html)
