...
Aircraft parts or wreckage obstructing the runway after an accident or incident.
...
After accident, gear failure, or engine debris on runway; pilot sees wreckage on approach.

## Who Uses It

Pilots report to Tower; airport authority coordinates runway closure.
...
WRECK — Warn Tower, Run missed approach, Expect alternate runway, Call souls/fuel if damaged, Keep holding.
...
- [ICAO Runway Safety](https://www.icao.int/safety/runwaysafety/pages/default.aspx)
