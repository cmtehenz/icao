...
Foreign object or material on a taxiway that may damage aircraft or block movement.
...
Taxi when equipment, parts, or FOD is visible on taxiway surface.

## Who Uses It

Pilots report to Ground; Ground alerts airport operations.
...
TAXI FOD — Stop, Announce to Ground, eXamine, Inform when safe.
