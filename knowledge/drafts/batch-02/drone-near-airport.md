...
Unmanned aircraft sighted near airport or aircraft, posing collision risk.
...
Taxi, departure, or approach when drone is observed near airfield or aircraft.

## Who Uses It

Pilots report to Tower or Ground; ATC issues traffic advisories.
...
DRONE — Detect, Report immediately, Observe position, No movement until cleared, Explain to Ground.
