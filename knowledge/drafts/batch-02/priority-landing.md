...
**Catalog ID:** 0060  
**Category:** Approach  
**Draft:** Premium batch-02 — working document (not consumed by Captain)

## Meaning

Request for preferential ATC handling to land before other traffic due to urgency.
...
Emergency, urgency, or time-critical situation requiring landing ahead of traffic.

## Who Uses It

Pilots request from Approach or Tower; ATC clears priority approach.
...
PRIORITY — Problem stated, Request clearly, Inform urgency, Order from ATC, Ready for straight-in, Identify nature, Touch down expeditiously.
...
- [ICAO Doc 4444 — Radiotelephony](https://www.icao.int/safety/airnavigation/pages/doc4444.aspx)
