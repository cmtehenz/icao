...
Pilot report or ATC acknowledgment that aircraft is first in landing sequence.
...
Downwind, base, or final when pilot believes they are first to land.

## Who Uses It

Pilot reports to Tower; Tower may confirm or correct sequence.
...
ONE — Only report when sure, Name runway, Expect Tower correction if wrong.
