...
Deliberate route or altitude change to stay clear of convective weather.
...
En route or approach when radar, visual, or METAR shows thunderstorm activity on path.

## Who Uses It

Pilots request deviation; Center/Approach clears weather avoidance routing.
...
STORM — See cells early, Tell ATC, Obtain clearance, Route around, Monitor METAR/radar.
