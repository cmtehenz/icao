...
Taxi, pushback, parking, and gate operations.

## Why it is used

Safe movement on the aerodrome surface.

## 5 realistic aviation examples

1. Ground, N456ST taxiing with caution for construction.
2. RESEARCH REQUIRED
3. RESEARCH REQUIRED
4. RESEARCH REQUIRED
5. RESEARCH REQUIRED
...
How would you report "Taxi with Caution" to ATC in an ICAO Part 2 situation?

## Captain teaching notes

Anchor on document phraseology: "Ground, N456ST taxiing with caution for construction.".
